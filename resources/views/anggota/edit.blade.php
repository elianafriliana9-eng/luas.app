                ...
                <div class="p-6">
                    ...
                    <form action="{{ route('anggota.update', $anggota->id) }}" method="POST" enctype="multipart/form-data"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                            ...
                            <div><label class="block text-sm font-medium text-gray-700 mb-1">Gaji Pokok</label><input type="text" name="gaji_pokok" value="{{ old('gaji_pokok', $anggota->gaji_pokok) }}" inputmode="decimal" class="input-rupiah w-full border rounded-lg px-3 py-2 text-sm @error('gaji_pokok') border-red-500 @enderror" oninput="formatRupiah(this)">@error('gaji_pokok') <p class="text-red-500 text-xs mt-1">{{ $message }}</p> @enderror</div>
