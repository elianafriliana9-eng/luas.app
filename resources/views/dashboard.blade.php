        ...
        <section class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div class="bg-surface-container-lowest p-6 rounded-xl border-l-4 border-primary shadow-sm hover:shadow-md transition-shadow">
                <div class="flex justify-between items-start mb-4">
                    <span class="p-2 bg-primary-fixed text-primary rounded-lg">
                        <span class="material-symbols-outlined">account_balance</span>
                    </span>
                    <span class="flex items-center gap-1 text-secondary text-sm font-bold font-data">
                        <span class="material-symbols-outlined text-sm">trending_up</span>
                        +{{ $growthAset }}%
                    </span>
                </div>
                <p class="text-sm font-medium text-slate-500">Total Aset</p>
                <h3 class="text-xl font-bold mt-1 font-data text-blue-900">Rp {{ number_format($totalAset, 0, ',', '.') }}</h3>
            </div>
            ...
            <div class="bg-surface-container-lowest p-6 rounded-xl border-l-4 border-secondary shadow-sm hover:shadow-md transition-shadow">
                <div class="flex justify-between items-start mb-4">
                    <span class="p-2 bg-secondary-container text-secondary rounded-lg">
                ...
                <div class="flex items-baseline gap-1 mt-1">
                    <h3 class="text-xl font-bold font-data text-blue-900">{{ number_format($anggotaAktif, 0, ',', '.') }}</h3>
            ...
            <div class="bg-surface-container-lowest p-6 rounded-xl border-l-4 border-tertiary shadow-sm hover:shadow-md transition-shadow">
                <div class="flex justify-between items-start mb-4">
                    <span class="p-2 bg-tertiary-fixed text-tertiary rounded-lg">
                        <span class="material-symbols-outlined">payments</span>
                    </span>
                    <span class="px-2 py-1 bg-error-container text-error text-[10px] font-bold rounded-full">
                        NPL {{ $nplRatio }}%
                    </span>
                </div>
                <p class="text-sm font-medium text-slate-500">Outstanding Pembiayaan</p>
                <h3 class="text-xl font-bold mt-1 font-data text-blue-900">Rp {{ number_format($outstandingPembiayaan, 0, ',', '.') }}</h3>
            </div>
            ...
            <div class="bg-surface-container-lowest p-6 rounded-xl border-l-4 border-primary shadow-sm hover:shadow-md transition-shadow">
                ...
                <h3 class="text-xl font-bold mt-1 font-data text-blue-900">Rp {{ number_format($totalSimpanan, 0, ',', '.') }}</h3>
            </div>
        </section>
