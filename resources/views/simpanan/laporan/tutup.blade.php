<x-app-layout>
    <div class="p-8 max-w-[1600px] mx-auto space-y-6">
        ...
        <section class="flex items-center justify-between">
            <div>
                <h2 class="text-2xl font-bold font-headline tracking-tight text-blue-900">Laporan Rekening Ditutup</h2>
                <p class="text-slate-500 text-sm mt-1">Daftar rekening simpanan yang sudah ditutup</p>
            </div>
                        ...
                        @empty
                            <tr>
                                <td colspan="6" class="px-6 py-16 text-center">
                                    <span class="material-symbols-outlined text-[48px] text-slate-300 mb-3 block">archive</span>
                                    <p class="text-sm text-slate-400 font-medium">Tidak ada rekening yang ditutup</p>
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
